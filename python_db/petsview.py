...
class Petsview:
    ...
    def retrieve(self,id):
        db=self.connect()
        cursor=db.cursor()
        query=f"select * from pets where id={id}"    #retrieve means to get data
        cursor.execute(query)
...
# print(pv.get())
# print(pv.retrieve(1))
# print(pv.post(age=26,gender="male",breed="breed3",location="kottayam",price=4000))
# print(pv.destroy(2))
print(pv.update id=3,age=26,gender="male",breed="breed3",location="kottayam"price=40000)
